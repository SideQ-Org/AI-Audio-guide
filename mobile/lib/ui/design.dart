...
class AppColors extends ThemeExtension<AppColors> {
  ...
  const AppColors({
    ...
    required this.meshA, required this.meshB, required this.meshC,
    required this.glass, required this.glassBorder, required this.glassHi,
    required this.header, required this.shadow,
    required this.primary, required this.onPrimary, required this.lime,
    required this.sage, required this.ok, required this.err, required this.glow,
    required this.textPrimary, required this.textSecondary, required this.textFaint,
  });

  static const light = AppColors(
    bgTop: Color(0xFFF6F2EA), bgBottom: Color(0xFFEBE1D2),
    meshA: Color(0x66C4E26B), meshB: Color(0x808FA99B), meshC: Color(0x8CEBCDA5),
    // Warm translucent glass — reads as a distinct block over the frosted map but still
    // lets it show through.
    glass: Color(0x94EDE6D8), glassBorder: Color(0xC2FFFFFF), glassHi: Color(0x99FFFFFF),
    header: Color(0xFFEBE4D5), shadow: Color(0x382D3C32),
    primary: Color(0xFF35674E), onPrimary: Color(0xFFFFFFFF), lime: Color(0xFFC4E26B),
    sage: Color(0xFF8FA99B), ok: Color(0xFF3FA574), err: Color(0xFFDE6A60), glow: Color(0xFF35674E),
    textPrimary: Color(0xFF20241C), textSecondary: Color(0xFF5C6157), textFaint: Color(0xFF98A091),
  );

  static const dark = AppColors(
    bgTop: Color(0xFF413E5C), bgBottom: Color(0xFF161520), // top lighter (approved)
    meshA: Color(0x66B496E1), meshB: Color(0x4D96BEE1), meshC: Color(0x33B496E1),
    glass: Color(0x6646445C), glassBorder: Color(0x29FFFFFF), glassHi: Color(0x21FFFFFF),
    header: Color(0xFF343149), shadow: Color(0x80000000),
    primary: Color(0xFF7FC79A), onPrimary: Color(0xFF0E1F16), lime: Color(0xFFC4E26B),
    sage: Color(0xFF8FA99B), ok: Color(0xFF5FC08C), err: Color(0xFFE88379), glow: Color(0xFFB07CE8),
    textPrimary: Color(0xFFEFEDF6), textSecondary: Color(0xFFABA8BC), textFaint: Color(0xFF87839A),
  );

  Color get onGlass => textPrimary; // ink over glass
  Color glassFill(double a) => textPrimary.withValues(alpha: a); // subtle tinted fill on glass
  ...
  AppColors lerp(covariant AppColors? other, double t) {
    ...
    return AppColors(
      bgTop: l(bgTop, other.bgTop), bgBottom: l(bgBottom, other.bgBottom),
      meshA: l(meshA, other.meshA), meshB: l(meshB, other.meshB), meshC: l(meshC, other.meshC),
      glass: l(glass, other.glass), glassBorder: l(glassBorder, other.glassBorder), glassHi: l(glassHi, other.glassHi),
      header: l(header, other.header), shadow: l(shadow, other.shadow),
      primary: l(primary, other.primary), onPrimary: l(onPrimary, other.onPrimary), lime: l(lime, other.lime),
      sage: l(sage, other.sage), ok: l(ok, other.ok), err: l(err, other.err), glow: l(glow, other.glow),
...
TextStyle display(BuildContext ctx) =>
    GoogleFonts.manrope(fontSize: 28, fontWeight: FontWeight.w800, height: 1.12, letterSpacing: -1, color: ctx.colors.textPrimary);
TextStyle h1(BuildContext ctx) =>
    GoogleFonts.manrope(fontSize: 24, fontWeight: FontWeight.w800, letterSpacing: -.5, color: ctx.colors.textPrimary);
TextStyle h2(BuildContext ctx) =>
    GoogleFonts.manrope(fontSize: 20, fontWeight: FontWeight.w800, letterSpacing: -.4, color: ctx.colors.textPrimary);
TextStyle titleS(BuildContext ctx) =>
    GoogleFonts.manrope(fontSize: 16, fontWeight: FontWeight.w700, color: ctx.colors.textPrimary);
TextStyle body(BuildContext ctx) =>
    GoogleFonts.manrope(fontSize: 15, fontWeight: FontWeight.w500, color: ctx.colors.textPrimary);
TextStyle label(BuildContext ctx) => GoogleFonts.manrope(
    fontSize: 12, fontWeight: FontWeight.w800, letterSpacing: .4, color: ctx.colors.textFaint);
TextStyle caption(BuildContext ctx) => GoogleFonts.manrope(
    fontSize: 12, fontWeight: FontWeight.w600, letterSpacing: .2, color: ctx.colors.textFaint);
...
class GradientBackground extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(begin: Alignment.topCenter, end: Alignment.bottomCenter, colors: [c.bgTop, c.bgBottom]),
      ),
...
class GlassModule extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return DecoratedBox(
      decoration: BoxDecoration(borderRadius: br, boxShadow: [
        BoxShadow(color: c.shadow, blurRadius: 34, spreadRadius: -14, offset: const Offset(0, 18)),
        BoxShadow(color: c.shadow, blurRadius: 8, spreadRadius: -5, offset: const Offset(0, 3)),
      ]),
      child: ClipRRect(
        borderRadius: br,
        child: BackdropFilter(
          ...
          child: Container(
            decoration: BoxDecoration(color: fill ?? c.glass, borderRadius: br, border: Border.all(color: c.glassBorder, width: 1)),
            child: Stack(children: [
              if (sheen)
                Positioned.fill(
                  child: IgnorePointer(
                    child: DecoratedBox(
                      decoration: BoxDecoration(
                        ...
                        gradient: LinearGradient(
                          ...
                          colors: [c.glassHi, Colors.transparent], stops: const [0, 0.5],
                        ),
                      ),
                    ),
                  ),
...
class AppButton extends StatelessWidget {
  ...
  const AppButton(this.label,
      {super.key, this.icon, this.trailing, this.onTap, this.kind = AppBtnKind.primary, this.height = 52, this.color});
  @override
  Widget build(BuildContext context) {
    final c = context.colors;
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: primary ? [BoxShadow(color: accent.withValues(alpha: 0.45), blurRadius: 22, spreadRadius: -8, offset: const Offset(0, 10))] : null,
          ),
          alignment: Alignment.center,
          child: Row(mainAxisAlignment: MainAxisAlignment.center, mainAxisSize: MainAxisSize.min, children: [
            if (icon != null) ...[Icon(icon, size: 18, color: fg), const SizedBox(width: 8)],
            Text(label, style: GoogleFonts.manrope(fontSize: 15, fontWeight: FontWeight.w800, color: fg)),
...
class FloatingTabBar extends StatelessWidget {
  ...
  static const _icons = [AppIcons.home, AppIcons.community, AppIcons.profile, AppIcons.settings];
  @override
  Widget build(BuildContext context) {
    final c = context.colors;
    ...
    return DecoratedBox(
      decoration: BoxDecoration(borderRadius: br, boxShadow: [
        BoxShadow(color: c.shadow, blurRadius: 34, spreadRadius: -14, offset: const Offset(0, 16)),
      ]),
      child: ClipRRect(
        borderRadius: br,
        child: BackdropFilter(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(color: c.glass, borderRadius: br, border: Border.all(color: c.glassBorder, width: 1)),
            child: LayoutBuilder(builder: (context, cons) {
              final tabW = cons.maxWidth / _icons.length;
              return SizedBox(
                height: 48,
                child: Stack(children: [
                  // The active pill slides to the selected tab (iOS-style).
                  AnimatedPositioned(
                    duration: Motion.med, curve: Motion.emphasized,
                    left: index * tabW, top: 0, bottom: 0, width: tabW,
                    child: Container(
                      decoration: BoxDecoration(
                        color: c.primary,
                        borderRadius: BorderRadius.circular(Radii.pill),
                        boxShadow: [BoxShadow(color: c.primary.withValues(alpha: .4), blurRadius: 16, spreadRadius: -6, offset: const Offset(0, 6))],
                      ),
                    ),
                  ),
                  Row(children: [
                        ...
                        child: GestureDetector(
                          ...
                          child: Center(
                            child: AnimatedScale(
                              ...
                              child: Icon(_icons[i], size: 24, color: i == index ? c.onPrimary : c.textSecondary),
                            ),
                          ),
                        ),
                      ),
